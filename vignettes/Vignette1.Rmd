...
Unless you change the options to ``options(superb.debug = 'none')``, the command will issue some additional
...
All the warnings issued begining with ``"FYI"`` are just information. Hereafter, the warnings
are inhibited.
