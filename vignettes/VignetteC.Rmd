...
First proposed by Fisher, trigonometric transformation is one way to represent proportions 
(Fisher proposed `cosine` transform, but later Zubin proposed the `arcsine` transform).
...
an analysis of proportions (ANOPA) is explained in @lc22. Analysis of 
proportion is now implemented in R with the package `ANOPA`.
