...
```{r, fig.width = 5, fig.cap="**Figure 1: A plot with SPSS data within R**"}
superbPlot( data, 
    WSFactors      = "Temps(2)",
...
Here are screen captures showing the syntax window and the resulting output window:

```{r fig2, echo=FALSE, fig.cap="**Figure 2: Syntax to generate a plot**", fig.width = 6, fig.height = 6}
library(png)
...
```{r fig3, echo=FALSE, fig.cap="**Figure 3: Plot generated**", fig.width = 6, fig.height = 6}
library(png)
fle2 <- system.file("extdata", "Output1.png", package = "superb")
img2 <- readPNG(fle2)
plot.new() 
