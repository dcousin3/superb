...
Consider a study trying to establish the benefit of using exercices to improve 
...
specifically a pre-exercices measure and a post-exercices measure of statistics reasoning.
...
The above suggests that within-subject designs can be much more powerfull than between-
