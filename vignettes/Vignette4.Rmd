...
## Changing the summary funtion to be plotted
...
# The sample size is very small (n=5) and the crrelation between scores is high (rho = .8)
dta <- GRD( 
...
tendancy, can be provided. That includes ``IQR``, ``mad``, etc. To be valid,
...
The function ``superbPlot`` is entirely customizable: you can put any decriptive statistic
